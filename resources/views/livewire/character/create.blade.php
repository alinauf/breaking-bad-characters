...
>
    ...
    <form action="{{url("characters")}}" method="POST">
                ...
                <fieldset class="space-y-5">
                    ...
                    <div class="relative flex items-start">
                        <div class="flex items-center h-5">
                            <input id="selected_shows.{{$key}}" value="{{$key}}" aria-describedby="comments-description" wire:model="selected_shows" name="selected_shows[]" type="checkbox" class=" focus:ring-primary-500 h-4 w-4 text-primary-600 border-gray-300 rounded">
                        </div>
        ...
        <x-confirm-create-modal title="Are you sure"
                                subtitle="Please confirm if you would like to create the character"/>
    </form>
</div>
